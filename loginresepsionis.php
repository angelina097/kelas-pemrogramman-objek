...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginFailed = "logingagalresepsionis.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_pemesananhotel, $pemesananhotel);
  
  $LoginRS__query=sprintf("SELECT id_resepsionis, nama_resepsionis FROM resepsionis WHERE id_resepsionis=%s AND nama_resepsionis=%s",
...
<form id="form4" name="form4" method="POST" action="<?php echo $loginFormAction; ?>">
  <div align="center">
    <table width="446" border="0">
      ...
      <tr>
        <td width="155" rowspan="3"><img src="gambar/158069842-10c8623e-68aa-4204-b0ec-bc7219702fdd.png" width="155" height="130" /></td>
        <td width="141">ID RESEPSIONIS</td>
        <td width="131"><label for="username"></label>
