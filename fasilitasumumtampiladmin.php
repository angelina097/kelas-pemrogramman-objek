      ...
      <div align="center">
        <table border="1">
          <tr>
            ...
            <td colspan="3" bgcolor="#FFFF99">Tools</td>
          </tr>
          <?php do { ?>
            <tr>
              ...
              <td><a href="fasilitasumumadmintambah.php"><img src="gambar/8-80460_add-plus-plus-sign-circle-png-clipart-removebg-preview (1).png" width="30" height="30" /></a></td>
              <td><a href="fasilitasumumadminedit.php?kolam_renang=<?php echo $row_fasilitasumumtampil['kolam_renang']; ?>"><img src="gambar/97-978138_writing-icon-png-edit-icon-vector-png-transparent-removebg-preview (1).png" width="30" height="30" /></a></td>
              <td><a href="fasilitasumumadminhapus.php?kolam_renang=<?php echo $row_fasilitasumumtampil['kolam_renang']; ?>"><img src="gambar/recycling-bin-vector-delete-icon-png-black-11563002079w1isxqyyiv-removebg-preview (1).png" width="30" height="30" /></a></td>
            </tr>
